...
const Banner = () => {
  return (
    <section id="home" className="relative h-[28rem] md:min-h-screen 2xl:min-h-0 2xl:h-[800px] w-full grid  overflow-hidden">
      <video
      ...
      <div className="relative z-10 p-4 md:ml-20 md:p-12 space-y-8 flex flex-col justify-center items-center md:items-start h-full">
