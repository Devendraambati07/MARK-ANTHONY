...
const Ourculture=()=>{
    ...
    <section id="ourculture">
        ...
        <p className="text-base md:text-xl font-normal text-[#FFFFFF]  text-center mt-6 leading-12 tracking-wider">At Mark Anthony, Our Culture is built on a Foundation of Integrity, Collaboration and Growth. Every member of our organization is driven by a shared commitment to Honesty, Hard work and delivering real values. Our Team blends market expertise with a people first approach, ensuring every interaction is guided by respect and purpose. At the Core, We don't Just builds deals, we build Trust, Relationship and Long lasting Impact.</p>
...
<p className="text-base md:text-xl font-normal text-[#FFFFFF]  text-center mt-6 leading-12 tracking-wider">Ranked Among India's <span className="text-[#FFCA66]">Top 10</span> Performing Real Estate Brokerage Firm</p>
        </div>
    </section>
    </>)
}
