...
const Ourculture=()=>{
    ...
    <section id="ourculture" style={{backgroundImage:`url(${bg})`,backgroundSize: "cover", backgroundPosition:'center', width:"100%", height:"auto"}}>
        <div className="flex flex-col space-y-3 h-auto md:min-h-screen 2xl:min-h-0 justify-center items-center py-6 md:py-20 px-4">
        <p className="font-normal text-xl md:text-4xl text-[#FFCA66] Abril tracking-[6px] ">OUR CULTURE</p>
        <p className="text-base md:text-xl font-normal text-[#FFFFFF] max-w-5xl text-center mt-6 leading-12 ">At Mark Anthony, Our Culture is built on a Foundation of Integrity, Collaboration and Growth. Every member of our organization is driven by a shared commitment to Honesty, Hard work and delivering real values. Our Team blends market expertise with a people first approach, ensuring every interaction is guided by respect and purpose. At the Core, We don't Just builds deals, we build Trust, Relationship and Long lasting Impact.</p>
